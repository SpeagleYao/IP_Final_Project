...
from models.RefineNet.resnet101 import get_resnet101, get_resnet50

from models.RefineNet.blocks import (RefineNetBlock, ResidualConvUnit,
...
def get_refinenet(input_size, num_classes, features=256, bn_momentum=0.01, pretrained=True):
    resnet50= get_resnet50(num_classes=num_classes, bn_momentum=bn_momentum)      # new ResNet proposed in PSPNet
